...
## Context
- Have a large black granite slab (uncut, 1.25" thick) to use as a dining room table top
- Granite will be cut larger than the base — overhang creates the final table size
- Granite adds 1.25" of height and ~400-500 lbs of weight
- Sydney base is built for stone tops (travertine) — no additional reinforcement needed

## The Plan
**CB2 Sydney 95" base + oversized granite top**
- Buy the Sydney base only — two options:
...
- Dark finish, double pedestal sculptural base, bullnose edge
- https://www.cb2.com/viggo-84-rectangular-dark-mango-wood-dining-table/s651201

## Other Options Considered
- **CB2 Toron 100" Oval** ($2,499) — solid mahogany, thick legs, 100"x44". Bigger but softer wood.
- **CB2 Providence 90"** ($1,444) — ebonized oak, parsons legs, fluted apron. Lighter build.
- **Arhaus Kensington Stone Top 96"** ($1,610 on sale) — designed for stone tops, dark slate finish. More traditional aesthetic.
- **ECon Parsons Metal Base** (~$500-1,200) — custom welded steel, handles granite easily. Powder coat looks cheap.
- **Anthropologie Sonali 96"** — beautiful sculptural double pedestal but resin legs, won't handle weight.
- **West Elm Ellington 86"** — fluted pedestal but resin legs, same concern.
...
- Overhang rules (Marble Institute): 1.25" thick granite = 10" max unsupported overhang. 1/3 rule also applies (overhang can't exceed 1/3 of total slab depth).
- Table cantilever is different from countertop support — confirm with fabricator. 8" overhang is conservative, 10" is the theoretical max.
- At 100" (8" overhang each end): seats 8 comfortably. At 104" (10" overhang): seats 8-10.
